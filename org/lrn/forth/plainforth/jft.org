...
** COMMENT Маски для FLAGS/LENGHT
...
** COMMENT Макросы DEFWORD и DEFCODE
...
** COMMENT Ввод и вывод: KEY EMIT WORD NUMBER
...
** COMMENT Сегмент стека и буффер ввода
