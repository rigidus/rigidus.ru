...
#+NAME: grouping
#+BEGIN_SRC elisp :var table=btn_fsm :results value scalar pp :hlines no :colnames yes
  (let ((result))
    (mapcar #'(lambda (par)
                (let ((from (second par))
                      (to   (third par)))
...
#+NAME: pseudocode
#+BEGIN_SRC elisp :var lst=grouping :results value scalar pp :hlines no :colnames yes
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (assert (equal '((progn-open) (progn-close))
                 (let ((ssa))
                   (recur
                    '(progn
                       (nop)))
  ...
  (add-recur-rule (lambda (lst)
                  ...
                  (lambda (lst)
                    (let ((reg1 (gensym "reg_setf_")))
                      ...
                      (push `(sts ,(caddr lst) ,reg1) ssa)
                      (push `(rfree ,reg1) ssa))))

  (assert (equal (format "%s" '((ralloc reg_setf_200)
                                (ldi reg_setf_200 2222)
                                (sts 2222 reg_setf_200)
                                (rfree reg_setf_200)))
                 (format "%s"
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (assert (equal (format "%s" '((ralloc reg_eq2_200)
                                (ralloc reg_eq2_201)
                                (ldi reg_eq2_200 VAR1)
                                (ldi reg_eq2_201 VAR2)
                                (cp reg_eq2_200 reg_eq2_201)
                                (rfree reg_eq2_200)
                                (rfree reg_eq2_201)
                                (brne _not_equal_eq2_202)
                                (set-result TRUE)
                                (rjmp _end_eq2_203)
                                (label _not_equal_eq2_202)
                                (set-result FALSE)
                                (label _end_eq2_203)))
...
#+BEGIN_SRC elisp :var a=recur :results value scalar pp
  ...
  (assert (equal (format "%s" '((ralloc reg_eq3_200)
                                (ralloc reg_eq3_201)
                                (ralloc reg_eq3_202)
                                (ldi reg_eq3_200 VAR1)
                                (ldi reg_eq3_201 VAR2)
                                (ldi reg_eq3_202 VAR2)
                                (cp reg_eq3_200 reg_eq3_201)
                                (rfree reg_eq3_200)
                                (brne _not_equal_eq3_203)
                                (cp reg_eq3_201 reg_eq3_202)
                                (rfree reg_eq3_201)
                                (rfree reg_eq3_202)
                                (brne _not_equal_eq3_203)
                                (set-result TRUE)
                                (rjmp _end_eq3_204)
                                (label _not_equal_eq3_203)
                                (set-result FALSE)
                                (label _end_eq3_204)))
                 (format "%s" (let ((gensym-counter 200)
                                    (ssa))
...
#+BEGIN_SRC elisp
  ...
  (assert (equal (format "%s" '((ralloc reg_eq2_202)
                                (ralloc reg_eq2_203)
                                (ldi reg_eq2_202 VAR1)
                                (ldi reg_eq2_203 VAR2)
                                (cp reg_eq2_202 reg_eq2_203)
                                (rfree reg_eq2_202)
                                (rfree reg_eq2_203)
                                (brne _not_equal_eq2_204)
                                (set-result TRUE)
                                (rjmp _end_eq2_205)
                                (label _not_equal_eq2_204)
                                (set-result FALSE)
                                (label _end_eq2_205)
                                (if-false _and_false_ret_200)
                                (ralloc reg_eq2_206)
                                (ralloc reg_eq2_207)
                                (ldi reg_eq2_206 VAR3)
                                (ldi reg_eq2_207 VAR4)
                                (cp reg_eq2_206 reg_eq2_207)
                                (rfree reg_eq2_206)
                                (rfree reg_eq2_207)
                                (brne _not_equal_eq2_208)
                                (set-result TRUE)
                                (rjmp _end_eq2_209)
                                (label _not_equal_eq2_208)
                                (set-result FALSE)
                                (label _end_eq2_209)
                                (if-false _and_false_ret_200)
                                (set-result TRUE)
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (assert (equal (format "%s" '((ralloc reg_eq2_202)
                                ...
                                (ralloc reg_setf_206)
                                (ldi reg_setf_206 2222)
                                (sts 2222 reg_setf_206)
                                (rfree reg_setf_206)
                                (rjmp when-end)
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (add-recur-rule (lambda (lst)
                  ...
                  (lambda (lst)
                    (let ((base       (gensym "reg_case_base_"))
                      ...
                      (push `(ldi ,base ,(cadr lst)) ssa)
                      (mapcar #'(lambda (clause)
                                  (let ((not-equal (gensym "_case_not_equal_")))
                                    (push `(ralloc ,cmp) ssa)
                                    (push `(ldi ,cmp ,(cadr lst)) ssa)
  ...
  (assert (equal (format "%s" '((ralloc reg_case_base_200)
                                (ldi reg_case_base_200 STATE)
                                (ralloc reg_case_cmp_201)
                                (ldi reg_case_cmp_201 STATE)
                                (cp reg_case_base_200 reg_case_cmp_201)
                                (rfree reg_case_cmp_201)
                                (brne _case_not_equal_203)
                                (progn-open)
                                (progn-close)
                                (rjmp _case_end_202)
                                (label _case_not_equal_203)
                                (ralloc reg_case_cmp_201)
                                (ldi reg_case_cmp_201 STATE)
                                (cp reg_case_base_200 reg_case_cmp_201)
                                (rfree reg_case_cmp_201)
                                (brne _case_not_equal_204)
                                (progn-open)
                                (progn-close)
                                (progn-open)
                                (progn-close)
                                (rjmp _case_end_202)
                                (label _case_not_equal_204)
                                (label _case_end_202)
                                (rfree reg_case_base_200)))
                 (format "%s" (let ((gensym-counter 200))
                                (let ((ssa))
                                  (recur
                                   '(case STATE
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (assert (equal (format "%s" '((ralloc reg_lt2_200)
                                (ralloc reg_lt2_201)
                                (ldi reg_lt2_200 CNT)
                                (ldi reg_lt2_201 MAX)
                                (cp reg_lt2_200 reg_lt2_201)
                                (rfree reg_lt2_200)
                                (rfree reg_lt2_201)
                                (brsh _not_lt_eq2_202)
                                (set-result TRUE)
                                (rjmp _end_lt2_203)
                                (label _not_lt_eq2_202)
                                (set-result FALSE)
                                (label _end_lt2_203)))
                 (format "%s" (let ((gensym-counter 200))
                                (let ((ssa))
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (assert (equal (format "%s" '((ralloc reg_incf_200)
                                (ldi reg_incf_200 nil)
                                (inc reg_incf_200 nil)
                                (sts nil reg_incf_200)
                                (rfree reg_incf_200)))
                 (format "%s" (let ((gensym-counter 200))
                                (let ((ssa))
                                  (recur
...
#+BEGIN_SRC elisp :var a=recur
  ...
  (assert (equal (format "%s" '((ralloc reg_lt2_200)
                                (ralloc reg_lt2_201)
                                (ldi reg_lt2_200 VAR1)
                                (ldi reg_lt2_201 VAR2)
                                (cp reg_lt2_200 reg_lt2_201)
                                (rfree reg_lt2_200)
                                (rfree reg_lt2_201)
                                (brlt _not_ge_eq2_202)
                                (set-result TRUE)
                                (rjmp _end_ge2_203)
                                (label _not_ge_eq2_202)
                                (set-result FALSE)
                                (label _end_ge2_203)))
                 (format "%s" (let ((gensym-counter 200))
                                (let ((ssa))
...
#+NAME: all
#+BEGIN_SRC elisp :var a=recur b=rnopprogn c=rsetf d=req2 e=req3 f=rand g=rwhen h=rless i=rincf j=rge k=rcase
  (format
   "%s"
   (pp
    (let ((gensym-counter 200))
...
((ralloc reg_case_base_200)
 ...
 (ralloc reg_eq2_206)
 (ralloc reg_eq2_207)
 (ldi reg_eq2_206 PREV)
 (ldi reg_eq2_207 NEXT)
 (cp reg_eq2_206 reg_eq2_207)
 (rfree reg_eq2_206)
 (rfree reg_eq2_207)
 (brne _not_equal_eq2_208)
 ...
 (set-result FALSE)
 (label _end_eq2_209)
 (if-false _when_false_ret_204)
 (ralloc reg_setf_210)
 (ldi reg_setf_210 1)
 (sts 1 reg_setf_210)
 (rfree reg_setf_210)
 (rjmp when-end)
 (label _when_false_ret_204)
 (set-result FALSE)
 (label _when_end_205)
 (ralloc reg_eq2_215)
 (ralloc reg_eq2_216)
 (ldi reg_eq2_215 PREV)
 (ldi reg_eq2_216 HIGH)
 (cp reg_eq2_215 reg_eq2_216)
 (rfree reg_eq2_215)
 (rfree reg_eq2_216)
 (brne _not_equal_eq2_217)
 (set-result TRUE)
 (rjmp _end_eq2_218)
 (label _not_equal_eq2_217)
 (set-result FALSE)
 (label _end_eq2_218)
 (if-false _and_false_ret_213)
 (ralloc reg_eq2_219)
 (ralloc reg_eq2_220)
 (ldi reg_eq2_219 NEXT)
 (ldi reg_eq2_220 LOW)
 (cp reg_eq2_219 reg_eq2_220)
 (rfree reg_eq2_219)
 (rfree reg_eq2_220)
 (brne _not_equal_eq2_221)
 (set-result TRUE)
 (rjmp _end_eq2_222)
 (label _not_equal_eq2_221)
 (set-result FALSE)
 (label _end_eq2_222)
 (if-false _and_false_ret_213)
 (set-result TRUE)
 (rjmp _and_end_214)
 (label _and_false_ret_213)
 (set-result FALSE)
 (label _and_end_214)
 (if-false _when_false_ret_211)
 (ralloc reg_setf_223)
 (ldi reg_setf_223 0)
 (sts 0 reg_setf_223)
 (rfree reg_setf_223)
 ...
 (cp reg_case_base_200 reg_case_cmp_201)
 (rfree reg_case_cmp_201)
 (brne _case_not_equal_225)
 (progn-open)
 (ralloc reg_eq3_230)
 (ralloc reg_eq3_231)
 (ralloc reg_eq3_232)
 (ldi reg_eq3_230 PREV)
 (ldi reg_eq3_231 NEXT)
 (ldi reg_eq3_232 NEXT)
 (cp reg_eq3_230 reg_eq3_231)
 (rfree reg_eq3_230)
 (brne _not_equal_eq3_233)
 (cp reg_eq3_231 reg_eq3_232)
 (rfree reg_eq3_231)
 (rfree reg_eq3_232)
 (brne _not_equal_eq3_233)
 (set-result TRUE)
 (rjmp _end_eq3_234)
 (label _not_equal_eq3_233)
 (set-result FALSE)
 (label _end_eq3_234)
 (if-false _and_false_ret_228)
 (ralloc reg_lt2_235)
 (ralloc reg_lt2_236)
 (ldi reg_lt2_235 CNT)
 (ldi reg_lt2_236 MAX)
 (cp reg_lt2_235 reg_lt2_236)
 (rfree reg_lt2_235)
 (rfree reg_lt2_236)
 (brsh _not_lt_eq2_237)
 (set-result TRUE)
 (rjmp _end_lt2_238)
 (label _not_lt_eq2_237)
 (set-result FALSE)
 (label _end_lt2_238)
 (if-false _and_false_ret_228)
 (set-result TRUE)
 (rjmp _and_end_229)
 (label _and_false_ret_228)
 (set-result FALSE)
 (label _and_end_229)
 (if-false _when_false_ret_226)
 (ralloc reg_incf_239)
 (ldi reg_incf_239 nil)
 (inc reg_incf_239 nil)
 (sts nil reg_incf_239)
 (rfree reg_incf_239)
 (ralloc reg_setf_240)
 (ldi reg_setf_240 2)
 (sts 2 reg_setf_240)
 (rfree reg_setf_240)
 (rjmp when-end)
 (label _when_false_ret_226)
 (set-result FALSE)
 (label _when_end_227)
 (ralloc reg_eq2_245)
 (ralloc reg_eq2_246)
 (ldi reg_eq2_245 PREV)
 (ldi reg_eq2_246 NEXT)
 (cp reg_eq2_245 reg_eq2_246)
 (rfree reg_eq2_245)
 (rfree reg_eq2_246)
 (brne _not_equal_eq2_247)
 (set-result TRUE)
 (rjmp _end_eq2_248)
 (label _not_equal_eq2_247)
 (set-result FALSE)
 (label _end_eq2_248)
 (if-false _and_false_ret_243)
 (ralloc reg_lt2_249)
 (ralloc reg_lt2_250)
 (ldi reg_lt2_249 CNT)
 (ldi reg_lt2_250 MAX)
 (cp reg_lt2_249 reg_lt2_250)
 (rfree reg_lt2_249)
 (rfree reg_lt2_250)
 (brlt _not_ge_eq2_251)
 (set-result TRUE)
 (rjmp _end_ge2_252)
 (label _not_ge_eq2_251)
 (set-result FALSE)
 (label _end_ge2_252)
 (if-false _and_false_ret_243)
 (set-result TRUE)
 (rjmp _and_end_244)
 (label _and_false_ret_243)
 (set-result FALSE)
 (label _and_end_244)
 (if-false _when_false_ret_241)
 (ralloc reg_setf_253)
 (ldi reg_setf_253 0)
 (sts 0 reg_setf_253)
 (rfree reg_setf_253)
 ...
 (rfree reg_setf_254)
 (rjmp when-end)
 (label _when_false_ret_241)
 (set-result FALSE)
 (label _when_end_242)
 (progn-close)
 (rjmp _case_end_202)
 (label _case_not_equal_225)
 (ralloc reg_case_cmp_201)
 (ldi reg_case_cmp_201 %STATE)
 (cp reg_case_base_200 reg_case_cmp_201)
 (rfree reg_case_cmp_201)
 (brne _case_not_equal_255)
 (progn-open)
 (ralloc reg_eq2_260)
 (ralloc reg_eq2_261)
 (ldi reg_eq2_260 PREV)
 (ldi reg_eq2_261 LOW)
 (cp reg_eq2_260 reg_eq2_261)
 (rfree reg_eq2_260)
 (rfree reg_eq2_261)
 (brne _not_equal_eq2_262)
 (set-result TRUE)
 (rjmp _end_eq2_263)
 (label _not_equal_eq2_262)
 (set-result FALSE)
 (label _end_eq2_263)
 (if-false _and_false_ret_258)
 (ralloc reg_eq2_264)
 (ralloc reg_eq2_265)
 (ldi reg_eq2_264 NEXT)
 (ldi reg_eq2_265 HIGH)
 (cp reg_eq2_264 reg_eq2_265)
 (rfree reg_eq2_264)
 (rfree reg_eq2_265)
 (brne _not_equal_eq2_266)
 (set-result TRUE)
 (rjmp _end_eq2_267)
 (label _not_equal_eq2_266)
 (set-result FALSE)
 (label _end_eq2_267)
 (if-false _and_false_ret_258)
 (set-result TRUE)
 (rjmp _and_end_259)
 (label _and_false_ret_258)
 (set-result FALSE)
 (label _and_end_259)
 (if-false _when_false_ret_256)
 (ralloc reg_setf_268)
 (ldi reg_setf_268 0)
 (sts 0 reg_setf_268)
 (rfree reg_setf_268)
 ...
 (rfree reg_setf_269)
 (rjmp when-end)
 (label _when_false_ret_256)
 (set-result FALSE)
 (label _when_end_257)
 (ralloc reg_eq3_274)
 (ralloc reg_eq3_275)
 (ralloc reg_eq3_276)
 (ldi reg_eq3_274 PREV)
 (ldi reg_eq3_275 NEXT)
 (ldi reg_eq3_276 NEXT)
 (cp reg_eq3_274 reg_eq3_275)
 (rfree reg_eq3_274)
 (brne _not_equal_eq3_277)
 (cp reg_eq3_275 reg_eq3_276)
 (rfree reg_eq3_275)
 (rfree reg_eq3_276)
 (brne _not_equal_eq3_277)
 (set-result TRUE)
 (rjmp _end_eq3_278)
 (label _not_equal_eq3_277)
 (set-result FALSE)
 (label _end_eq3_278)
 (if-false _and_false_ret_272)
 (set-result TRUE)
 (rjmp _and_end_273)
 (label _and_false_ret_272)
 (set-result FALSE)
 (label _and_end_273)
 (if-false _when_false_ret_270)
 (ralloc reg_setf_279)
 (ldi reg_setf_279 3)
 (sts 3 reg_setf_279)
 (rfree reg_setf_279)
 (rjmp when-end)
 (label _when_false_ret_270)
 (set-result FALSE)
 (label _when_end_271)
 (progn-close)
 (rjmp _case_end_202)
 (label _case_not_equal_255)
 (label _case_end_202)
 (rfree reg_case_base_200))
#+end_example
...
#+NAME: codegen
#+BEGIN_SRC elisp var a=recur :results output
  (mapcar
   #'(lambda (op)
       (cond
        ((eql 'label (car op))
...
#+NAME: more_complex
#+BEGIN_SRC elisp :var lst=pseudocode ssa=ssa :results value scalar pp
  (let ((gensym-counter 200))
    (let ((ssa))
      (recur
       '(when (and
