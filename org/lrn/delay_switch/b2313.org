...
#+BEGIN_SRC elisp
  ...
  (add-recur-rule (lambda (lst)
                  ...
                  (lambda (lst)
                    (let ((var1 (cadr lst))           (var2 (caddr lst))
                          (reg1 (gensym "reg_eq2_"))  (reg2 (gensym "reg_eq2_"))
  ...
  (assert (equal (format "%s" '((ldi reg_eq2_200 VAR1)
...
#+BEGIN_SRC elisp
  ...
  (assert (equal (format "%s" '((ldi reg_eq3_200 VAR1)
...
#+BEGIN_SRC elisp
  ...
  (assert (equal (format "%s" '((ldi reg_eq2_202 VAR1)
...
#+BEGIN_SRC elisp
  ...
  (assert (equal (format "%s" '((ldi reg200 STATE)
                                (ldi reg201 STATE)
                                (cp reg200 reg201)
                                (brne _case_not_equal_203)
                                (set-const-to-var V1 1)
                                (rjmp _case_end_202)
                                (label _case_not_equal_203)
                                (ldi reg201 STATE)
                                (cp reg200 reg201)
                                (brne _case_not_equal_204)
                                (set-const-to-var V2 2)
                                (set-const-to-var V3 3)
                                (rjmp _case_end_202)
