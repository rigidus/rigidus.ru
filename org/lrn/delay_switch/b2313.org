...
((ralloc reg_case_base_200)
 ...
 (ralloc reg_eq3_207)
 (ralloc reg_eq3_208)
 (ldi reg_eq3_206 PREV)
 (ldi reg_eq3_207 NEXT)
 (ldi reg_eq3_208 NEXT)
 (cp reg_eq3_206 reg_eq3_207)
 (rfree reg_eq3_206)
 (brne _not_equal_eq3_209)
 (cp reg_eq3_207 reg_eq3_208)
 (rfree reg_eq3_207)
 (rfree reg_eq3_208)
 (brne _not_equal_eq3_209)
 (set-result TRUE)
 (rjmp _end_eq3_210)
 (label _not_equal_eq3_209)
 (set-result FALSE)
 (label _end_eq3_210)
 ...
 (ralloc reg_eq2_216)
 (ralloc reg_eq2_217)
 (ldi reg_eq2_216 PREV)
 (ldi reg_eq2_217 HIGH)
 (cp reg_eq2_216 reg_eq2_217)
 (rfree reg_eq2_216)
 (rfree reg_eq2_217)
 (brne _not_equal_eq2_218)
 (set-result TRUE)
 (rjmp _end_eq2_219)
 (label _not_equal_eq2_218)
 (set-result FALSE)
 (label _end_eq2_219)
 (if-false _and_false_ret_214)
 (ralloc reg_eq2_220)
 (ralloc reg_eq2_221)
 (ldi reg_eq2_220 NEXT)
 (ldi reg_eq2_221 LOW)
 (cp reg_eq2_220 reg_eq2_221)
 (rfree reg_eq2_220)
 (rfree reg_eq2_221)
 (brne _not_equal_eq2_222)
 (set-result TRUE)
 (rjmp _end_eq2_223)
 (label _not_equal_eq2_222)
 (set-result FALSE)
 (label _end_eq2_223)
 (if-false _and_false_ret_214)
 (set-result TRUE)
 (rjmp _and_end_215)
 (label _and_false_ret_214)
 (set-result FALSE)
 (label _and_end_215)
 (if-false _when_false_ret_212)
 (ralloc reg_setf_224)
 (ldi reg_setf_224 0)
 (sts 0 reg_setf_224)
 (rfree reg_setf_224)
 ...
 (ralloc reg_eq3_232)
 (ralloc reg_eq3_233)
 (ldi reg_eq3_231 PREV)
 (ldi reg_eq3_232 NEXT)
 (ldi reg_eq3_233 NEXT)
 (cp reg_eq3_231 reg_eq3_232)
 (rfree reg_eq3_231)
 (brne _not_equal_eq3_234)
 (cp reg_eq3_232 reg_eq3_233)
 (rfree reg_eq3_232)
 (rfree reg_eq3_233)
 (brne _not_equal_eq3_234)
 (set-result TRUE)
 (rjmp _end_eq3_235)
 (label _not_equal_eq3_234)
 (set-result FALSE)
 (label _end_eq3_235)
 (if-false _and_false_ret_229)
 (ralloc reg_lt2_236)
 (ralloc reg_lt2_237)
 (ldi reg_lt2_236 CNT)
 (ldi reg_lt2_237 MAX)
 (cp reg_lt2_236 reg_lt2_237)
 (rfree reg_lt2_236)
 (rfree reg_lt2_237)
 (brsh _not_lt_eq2_238)
 (set-result TRUE)
 (rjmp _end_lt2_239)
 (label _not_lt_eq2_238)
 (set-result FALSE)
 (label _end_lt2_239)
 (if-false _and_false_ret_229)
 (set-result TRUE)
 (rjmp _and_end_230)
 (label _and_false_ret_229)
 (set-result FALSE)
 (label _and_end_230)
 (if-false _when_false_ret_227)
 (ralloc reg_incf_240)
 (ldi reg_incf_240 nil)
 (inc reg_incf_240 nil)
 (sts nil reg_incf_240)
 (rfree reg_incf_240)
 (ralloc reg_setf_241)
 (ldi reg_setf_241 2)
 (sts 2 reg_setf_241)
 (rfree reg_setf_241)
 (rjmp _when_end_228)
 (label _when_false_ret_227)
 (set-result FALSE)
 (label _when_end_228)
 (ralloc reg_eq2_246)
 (ralloc reg_eq2_247)
 (ldi reg_eq2_246 PREV)
 (ldi reg_eq2_247 NEXT)
 (cp reg_eq2_246 reg_eq2_247)
 (rfree reg_eq2_246)
 (rfree reg_eq2_247)
 (brne _not_equal_eq2_248)
 (set-result TRUE)
 (rjmp _end_eq2_249)
 (label _not_equal_eq2_248)
 (set-result FALSE)
 (label _end_eq2_249)
 (if-false _and_false_ret_244)
 (ralloc reg_lt2_250)
 (ralloc reg_lt2_251)
 (ldi reg_lt2_250 CNT)
 (ldi reg_lt2_251 MAX)
 (cp reg_lt2_250 reg_lt2_251)
 (rfree reg_lt2_250)
 (rfree reg_lt2_251)
 (brlt _not_ge_eq2_252)
 (set-result TRUE)
 (rjmp _end_ge2_253)
 (label _not_ge_eq2_252)
 (set-result FALSE)
 (label _end_ge2_253)
 (if-false _and_false_ret_244)
 (set-result TRUE)
 (rjmp _and_end_245)
 (label _and_false_ret_244)
 (set-result FALSE)
 (label _and_end_245)
 (if-false _when_false_ret_242)
 (ralloc reg_setf_254)
 (ldi reg_setf_254 0)
 (sts 0 reg_setf_254)
 (rfree reg_setf_254)
 ...
 (rfree reg_setf_255)
 (rjmp _when_end_243)
 (label _when_false_ret_242)
 (set-result FALSE)
 (label _when_end_243)
 (progn-close)
 (rjmp _case_end_202)
 (label _case_not_equal_226)
 (ralloc reg_case_cmp_201)
 (ldi reg_case_cmp_201 %STATE)
 (cp reg_case_base_200 reg_case_cmp_201)
 (rfree reg_case_cmp_201)
 ...
 (ralloc reg_eq2_261)
 (ralloc reg_eq2_262)
 (ldi reg_eq2_261 PREV)
 (ldi reg_eq2_262 LOW)
 (cp reg_eq2_261 reg_eq2_262)
 (rfree reg_eq2_261)
 (rfree reg_eq2_262)
 (brne _not_equal_eq2_263)
 (set-result TRUE)
 (rjmp _end_eq2_264)
 (label _not_equal_eq2_263)
 (set-result FALSE)
 (label _end_eq2_264)
 (if-false _and_false_ret_259)
 (ralloc reg_eq2_265)
 (ralloc reg_eq2_266)
 (ldi reg_eq2_265 NEXT)
 (ldi reg_eq2_266 HIGH)
 (cp reg_eq2_265 reg_eq2_266)
 (rfree reg_eq2_265)
 (rfree reg_eq2_266)
 (brne _not_equal_eq2_267)
 (set-result TRUE)
 (rjmp _end_eq2_268)
 (label _not_equal_eq2_267)
 (set-result FALSE)
 (label _end_eq2_268)
 (if-false _and_false_ret_259)
 (set-result TRUE)
 (rjmp _and_end_260)
 (label _and_false_ret_259)
 (set-result FALSE)
 (label _and_end_260)
 (if-false _when_false_ret_257)
 (ralloc reg_setf_269)
 (ldi reg_setf_269 0)
 (sts 0 reg_setf_269)
 (rfree reg_setf_269)
 ...
 (rfree reg_setf_270)
 (rjmp _when_end_258)
 (label _when_false_ret_257)
 (set-result FALSE)
 (label _when_end_258)
 (ralloc reg_eq3_275)
 (ralloc reg_eq3_276)
 (ralloc reg_eq3_277)
 (ldi reg_eq3_275 PREV)
 (ldi reg_eq3_276 NEXT)
 (ldi reg_eq3_277 NEXT)
 (cp reg_eq3_275 reg_eq3_276)
 (rfree reg_eq3_275)
 (brne _not_equal_eq3_278)
 (cp reg_eq3_276 reg_eq3_277)
 (rfree reg_eq3_276)
 (rfree reg_eq3_277)
 (brne _not_equal_eq3_278)
 (set-result TRUE)
 (rjmp _end_eq3_279)
 (label _not_equal_eq3_278)
 (set-result FALSE)
 (label _end_eq3_279)
 (if-false _and_false_ret_273)
 (set-result TRUE)
 (rjmp _and_end_274)
 (label _and_false_ret_273)
 (set-result FALSE)
 (label _and_end_274)
 (if-false _when_false_ret_271)
 (ralloc reg_setf_280)
 (ldi reg_setf_280 3)
 (sts 3 reg_setf_280)
 (rfree reg_setf_280)
 (rjmp _when_end_272)
 (label _when_false_ret_271)
 (set-result FALSE)
 (label _when_end_272)
 (progn-close)
 (rjmp _case_end_202)
 (label _case_not_equal_256)
 (label _case_end_202)
 (rfree reg_case_base_200))
#+end_example
...
#+BEGIN_SRC elisp
  ...
  (defun ralloc (var)
    (catch 'ret
      (dolist (reg *registers*)
        (when (null (cadr reg))
          (setq *registers*
                (append (delq reg *registers*)
                        (list (list (car reg) var))))
          (throw 'ret (car reg))))
  ...
  (defun rfree (reg)
    (catch 'ret
      (dolist (cur *registers*)
        (when (equal reg (car cur))
          (setq *registers*
                (delq cur *registers*))
          (push (list reg nil)
                ,*registers*)
...
#+BEGIN_SRC elisp :var all=all r=regs :results output org :wrap "SRC asm"
  (let ((allocs)
        ...
        (var-to-reg (lambda (var)
                      (let ((pair (cl-member var allocs
                                             :test (lambda (a b)
                                                     (equal a (car b))))))
                        (if (null pair) ;; error if empty result
                            (progn
                              (message "Error: not such variable %s" var)
                              (error "Error: not such variable"))
                          (cadar pair))))))
    (mapcar
     #'(lambda (op)
         (cond ((eql 'ralloc (car op))
               ...
               ((eql 'rfree (car op))
                (let ((pair (cl-member (cadr op) allocs
                  ...
                  (if (null pair) ;; error if empty result
                      (error "Error in free handler: not such variable")
                    (let ((reg (cadar pair)))
                      (rfree reg)
                      (setf allocs
