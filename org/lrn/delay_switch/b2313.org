...
_and_end_215:
    ...
    ldi r22, 0
    sts r22, reg_setf_224
    ldi r22, 3
    sts r22, reg_setf_225
    rjmp _when_end_213
_when_false_ret_212:
    ldi result FALSE
_when_end_213:
...
::=-> inc : (inc reg_incf_240 nil)
    sts r23, reg_incf_240
    ldi r23, 2
    sts r23, reg_setf_241
    rjmp _when_end_228
_when_false_ret_227:
    ldi result FALSE
_when_end_228:
...
_and_end_245:
    ...
    ldi r23, 0
    sts r23, reg_setf_254
    ldi r23, 1
    sts r23, reg_setf_255
    rjmp _when_end_243
_when_false_ret_242:
    ldi result FALSE
_when_end_243:
...
_and_end_260:
    ...
    ldi r23, 0
    sts r23, reg_setf_269
    ldi r23, 2
    sts r23, reg_setf_270
    rjmp _when_end_258
_when_false_ret_257:
    ldi result FALSE
_when_end_258:
