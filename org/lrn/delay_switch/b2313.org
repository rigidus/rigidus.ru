...
#+NAME: all
#+BEGIN_SRC elisp :var z=pseudocode a=recur b=rnopprogn c=rsetf d=req2 f=rand g=rwhen h=rless i=rincf j=rge k=rcase
  (format
   "%s"
   (pp
...
#+BEGIN_SRC asm
  ...
  _yellow_on:
      ...
      push    tmp1
      in      tmp0, PORTB
      ldi     tmp1, 0b00000010    ; Устанавливаем только PB1
      or      tmp0, tmp1
      out     PORTB, tmp0
      pop     tmp1
      pop     tmp0
  ...
  _yellow_off:
      ...
      push    tmp1
      in      tmp0, PORTB
      ldi     tmp1, 0b11111101    ; Сбрасываем только PB1
      and     tmp0, tmp1
      out     PORTB, tmp0
      pop     tmp1
      pop     tmp0
