...
[TODO:gmm] в labels можно сначала сделать замыкания с полем env указывающим на nil, а потом инжектить в них окружения
...
[TODO:gmm] И тест тоже не возвращает корректного значения
