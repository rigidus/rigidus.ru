...
#+BEGIN_SRC lisp
  ;; Тесты для EVADD
  (assert (equal 0 (evadd '() nil)))
  (assert (equal 2 (evadd '(2) nil)))
  (assert (equal 5 (evadd '(2 3) nil)))
  ...
  (assert (equal (let ((a 2)
                       ...
                       (c 4))
                   (+ a b c))
                 (evadd '(2 3 4) '((a . 2) (b . 3) (c . 4)))))
  ;; Тесты для EVMUL
  (assert (equal 1 (evmul '() nil)))
  (assert (equal 2 (evmul '(2) nil)))
  (assert (equal 6 (evmul '(2 3) nil)))
