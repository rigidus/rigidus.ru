...
При создании ~tagbody~ мы [TODO:gmm] что делаем?

Нам потребуется несколько дополнительных функций:

#+NAME: my_eval_evtagbody_6
#+BEGIN_SRC lisp
...
При создании ~go~ мы [TODO:gmm] что делаем?
