...
** TODO Работа с CONS-ячейками

[TODO:gmm] Отличие в вызове ~apply-continuations~
...
[TODO:gmm] Этого вообще нет в исходнике почему-то
...
** TODO Самовычисляемые формы

[TODO:gmm] Замена ~funcall cont~ на ~apply-continauation~
...
[TODO:gmm] Отличие в вызове ~apply-continuations~ (поправить чтобы больше аргументов)
...
[TODO:gmm] Заменяем ~funcall cont~ на ~apply-continuation~
...
[TODO:gmm] Заменяем ~funcall cont~ на ~apply-continuation~. Проверить IT
...
[TODO:gmm] Заменяем ~funcall~ на ~apply-continuation~
