...
оптимизацию хвостовой рекурсии, что само по позволяет сделат более эффективный код.
...
подсписки. [TODO:gmm] Однако добавить рекурсивную обработку подсписков у меня не
получается..
