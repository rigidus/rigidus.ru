...
#+BEGIN_SRC lisp :tangle routes.lisp :noweb tangle :exports code :padline no :comments link
  ...
  (restas:mount-module -css- (#:restas.directory-publisher)
    (:url "/css/")
    (restas.directory-publisher:*directory* (pathname *css-path*)))
  ...
  (restas:mount-module -js- (#:restas.directory-publisher)
    (:url "/js/")
    (restas.directory-publisher:*directory* (pathname *js-path*)))

  (restas:mount-module -img- (#:restas.directory-publisher)
    (:url "/img/")
    (restas.directory-publisher:*directory* (pathname *img-path*)))
