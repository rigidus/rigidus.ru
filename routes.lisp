...
(defparameter *leftcol*
  (concatenate
   ...
   (§ ("Что здесь происходит?")
      ...
      "Распределенность, свободность и большая отказоустойчивость позволили реализовать обновления и разворачивание системы на боевых серверах надежнее и проще. Восстановление после сбоев стало гарантированным и очень быстрым. Доказано: <a href=\"http://ru.wikipedia.org/wiki/Git\" rel=\"nofollow\">GIT</a> способны легко понять не только программисты, но и аналитики, верстальщики и контент-менеджеры."
      ...
      "★ <a href=\"http://dropbox.com\" rel=\"nofollow\">Dropbox</a> in production! Теперь контент-менеджеры удобно работают с
                                    данными одновременно, а версионирование страхует их от ошибок.")))
